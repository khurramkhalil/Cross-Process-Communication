...
# Getting Feedback from client 'TEWA' if temprature is high
...
for update_nbr in range(100):
    ...
    if int(temperature) > 120:
        rec_.append([pub_time, time.time_ns(), zip_filter, total_temp, relhumidity])
        print(f"Data Recieved: {zipcode} {pub_time} {temperature}")
    ...
    try:
        ...
        rec_1.append([pub_time, time.time_ns(), zip_filter, temp, relhumidity])
